...
void sendemail(char *email, char *body)
{
    ...
    their_addr.sin_addr.s_addr = inet_addr("183.47.101.192");//qq smtp 服务器
...
int main()
{
    char email[] = "yihl.cn@163.com";
    char body[] = "From: \"lucy\"<329996282@qq.com>\r\n"
    "To: \"dasiy\"<yihl.cn@163.com>\r\n"
    "Subject: Hello\r\n\r\n"
    "Hello World!";
