...
static int edt_ft5426_ts_reset(struct edt_ft5426_dev *ft5426)
{
	...
	/* 从设备树中获取复位管脚 */
	ft5426->reset_gpio = of_get_named_gpio(client->dev.of_node, "reset-gpio", 0);
...
static int edt_ft5426_ts_irq(struct edt_ft5426_dev *ft5426)
{
	...
	/* 从设备树中获取中断管脚 */
	ft5426->irq_gpio = of_get_named_gpio(client->dev.of_node, "interrupt-gpio", 0);
...
MODULE_DESCRIPTION("EDT FT5426 I2C Touchscreen Driver");
MODULE_LICENSE("GPL");
